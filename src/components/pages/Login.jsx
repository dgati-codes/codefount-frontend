    ...
    <div className="auth-page">
      ...
      <div className="auth-promo">
        <div className="auth-promo__inner">
          ...
          <h2 className="auth-promo__h1">Welcome Back to <span>CodeFount</span></h2>
          <p className="auth-promo__sub">Sign in to access your courses, track your progress and connect with your cohort.</p>
          <div className="auth-promo__items">
            {['Access your enrolled courses','View training schedules','Download certificates','Chat with your instructor'].map(i => (
      ...
      <div className="auth-form-side">
        <div className="auth-form-box">
            ...
            <div className="auth-fields">
              ...
              <div className="form-group">
                ...
                <div className="auth-pw">
                  <input className="form-input" type={show?'text':'password'} placeholder="••••••••" value={pass} onChange={e => setPass(e.target.value)} required/>
          ...
          <Link to="/register" className="btn btn-outline btn-lg auth-submit">Create an Account</Link>
        </div>
      </div>
    </div>
  );
